  ...
  return (
    <div className="sidebar">
      ...
      <ul>
        ...
        <li
          className={useLocation().pathname === "/estudiantes" ? "active" : ""}
        >
        ...
        <li
          className={useLocation().pathname === "/profesores" ? "active" : ""}
        >
        ...
        <li
          className={useLocation().pathname === "/asignaturas" ? "active" : ""}
        >
